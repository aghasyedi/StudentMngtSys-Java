...
<div class="main-content">
    <div id="left-pane">
        <ul>
		    <li><a href="#add" onclick="loadPagec('/Smss/web/includes/main/program/addProgram.html'); return false;">Add Program</a></li>
		    <li><a href="#update" onclick="loadPagec('/Smss/web/includes/main/program/updateProgram.html'); return false;">Update Program</a></li>
		    <li><a href="#delete" onclick="loadPagec('/Smss/web/includes/main/program/deleteProgram.html'); return false;">Delete Program</a></li>
		    <li><a href="#getst" onclick="loadPagec('/Smss/web/includes/main/program/getProgramById.html'); return false;">Get Program by ID</a></li>
		    <li><a href="#getall" onclick="loadPagec('/Smss/web/includes/main/program/getAllPrograms.jsp'); return false;">Get All Programs</a></li>
		</ul>
    </div>
