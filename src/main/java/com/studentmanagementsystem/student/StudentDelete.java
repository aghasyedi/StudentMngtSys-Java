...
public class StudentDelete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println("<form action=\"DeleteStudent\" method=\"post\" onsubmit=\"return confirm('Are you sure you want to delete this student?')\">");
        response.getWriter().println("<div class=\"form-group\">");
        response.getWriter().println("<label>Are you sure to delete the given Student?<br></label>");
        ...
        response.getWriter().println("<input  type=\"hidden\" class=\"rounded-input\" id=\"deleteStudentId\" name=\"deleteStudentId\" value=\"" + deleteStudentId + "\" readonly>");
        response.getWriter().println("</div>");
        response.getWriter().println("<button type=\"submit\" class=\"btn\" name=\"action\" value=\"delete\" >Confirm Delete Student</button>");
